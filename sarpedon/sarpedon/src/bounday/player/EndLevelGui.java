...
public class EndLevelGui extends JFrame {
	 ...
	 * Create the frame.
	 */
	public EndLevelGui(SarpedonKabasuji game, JFrame levelGui, PlayerApplication aPA) {
		...
		btnNewButton.addActionListener(new SwitchWindowController(this, levelGui, new LevelSelectGui(game,aPA)));
	}
}
